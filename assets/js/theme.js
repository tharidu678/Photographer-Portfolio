...
(function ($) {
  ...
  // my adding
  // click and show read more items
  $(document).ready(function () {
    $(".read-more").click(function (event) {
      ...
      if (hiddenText.css("display") === "none") {
        hiddenText.slideDown("fast"); // Show the hidden text with smooth animation
        $(this).text("Read Less"); // Change button text
      } else {
        hiddenText.slideUp("fast"); // Hide the hidden text with smooth animation
  ...
  //     setTimeout(function () {
  //       // Set volume to 0.5 (half of maximum volume)
  //       audio1.volume = 0.3;
  //       audio1.play();
